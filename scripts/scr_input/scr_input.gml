...
function read_input(arg0, arg1 = false)
{
    var canRead = true;
    var _returnKey = false;
    var _returnPad = false;
    var keyboardKey = variable_struct_get(global.inputMap, string("Inputs_Player{0}_{1}Key", key_player, arg0));
    var gamepadButton = variable_struct_get(global.inputMap, string("Inputs_Player{0}_{1}Pad", key_player, arg0));
