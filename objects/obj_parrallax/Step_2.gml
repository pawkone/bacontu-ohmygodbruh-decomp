...
for (var i = 0; i < array_length(layers); i++)
{
    ...
    switch (layer_name)
    {
        ...
        case "Backgrounds_still1":
            ...
            if (sprite_get_width(layer_background_get_sprite(back_id)) > obj_screensizer.displayWidth)
            {
                var amt = sprite_get_width(layer_background_get_sprite(back_id)) - obj_screensizer.displayWidth;
            ...
            if (sprite_get_height(layer_background_get_sprite(back_id)) > obj_screensizer.displayHeight)
            {
                var amt = sprite_get_height(layer_background_get_sprite(back_id)) - obj_screensizer.displayHeight;
        ...
        case "Foregrounds_ground1":
            layer_x(lay, camx * -0.25);
            layer_y(lay, room_height - obj_screensizer.displayHeight);
            break;
